    ...
    <div className="group relative overflow-hidden rounded-xl border border-border/50 bg-card shadow-md hover:shadow-xl hover:border-border/70 transition-all duration-300">
      <div className="p-3">
        ...
        >
          {/* Category with Label */}
          <div className="mb-2">
            <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider inline-block mr-2">Category: </span>
          ...
          <div className="mb-2">
            <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider inline-block mr-2">Product: </span>
            <h3 className="text-sm font-bold text-foreground leading-tight inline">{item.productSuite}</h3>
          </div>

          {/* Vendor - Clear Label */}
          <div className="mb-2">
            <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider inline-block mr-2">Vendor: </span>
            <span className="text-xs text-foreground font-medium">{item.vendor}</span>
          </div>

          {/* ROI Dimensions - Colorful Badges in One Line (Smaller Size) */}
          <div>
            <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider block mb-1">ROI Dimensions: </span>
              ...
              {item.roiDimensions.map((dim, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[9px] font-medium whitespace-nowrap">{dim.label}</span>
                  </div>
                );
              })}
            </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-1 pt-2 border-t border-border/50">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Integration: </span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Update: </span>
              <span className="text-[10px] text-foreground font-medium">{item.updateFrequency}</span>
            </div>
          </div>
        </div>
      </div>
